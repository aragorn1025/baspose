...
if body[11]['x'][0] < body[14]['x'][0]:
    ...
    print(comment_1)
    if comment_1 == 0:
        database_connect.layup(video_id, comment_1, 11, 11, new_video_path, video_date)
        exit()
    ...
    print(comment_3)
    if comment_3 == 0:
        database_connect.layup(video_id, comment_1, comment_3, 11, new_video_path, video_date)
        exit()

    comment_4 = check_arm(jf, index)
    database_connect.layup(video_id, comment_1, comment_3, comment_4, new_video_path, video_date)
    ...
    print(comment_1)
    if comment_1 == 0:
        database_connect.layup(video_id, comment_1, 11, 11, new_video_path, video_date)  # 11 : 代表前面錯誤就不判斷後面的動作
        exit()
    ...
    comment_4 = check_arm(jf, index)
    database_connect.layup(video_id, comment_1, comment_3, comment_4, )
